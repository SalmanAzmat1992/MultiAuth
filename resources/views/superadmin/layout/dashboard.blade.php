...
<head><base href="../../">
    <meta charset="utf-8" />
    <title>Super Admin | Landing Page</title>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/media/logos/fav_icon_small.png') }}" />
...
<!--begin::Header Mobile-->
    @include('superadmin.layout.mobile_header')
<!--end::Header Mobile-->
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row flex-column-fluid page">
        ...
        <!--begin::Aside-->
        @include('superadmin.layout.menu')
        <!--end::Aside-->
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label"  @if(empty(Auth::user()->image)) style="background-image:url('{{ asset('assets/media/users/no_profile.png') }}')" @else style="background-image:url('{{ Auth::user()->image }}')" @endif ></div>
